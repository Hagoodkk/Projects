...
**Table of Contents**
1. **Chat App (Personal Project)** - **Can be found in github.com/Hagoodkk, in the repositories SocketClient and SocketServer**
Chat application with a multi-threaded server that accepts client connections through the uses of sockets. It uses data streams and serializable objects to pass back and forth information. JavaFX is used for UI development. Use usernames "Joan" and "Bob" for testing purposes. IntelliJ IDE used for development and application runs on this platform.
