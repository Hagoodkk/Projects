...
\hspace*{1.0in} \begin{itshape}OSGi Multitenant Cloud Application \hfill Aug 2016 - Present\end{itshape}
\begin{itemize}
...
\hspace*{1.0in}\begin{itshape}Hungr Android Project \hfill Aug 2016 - Dec 2016 \end{itshape}
\begin{itemize}
% Removes unnecessary spacing between items in list
\setlength{\itemsep}{1pt}
  \setlength{\parskip}{0pt}
